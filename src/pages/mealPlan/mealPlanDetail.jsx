...
function MealPlanDetail() {
    ...
    return (
        <div>
            {/* <div> */}
            {/* <div id="mealPlanNameBox"> */}
            <div>{mealPlanName}</div>
            {/* <button onClick={handleNameChangeClick}>수정</button>
                </div> */}
            {/* <Form id="mealPlanNameChangeBox" onSubmit={handleSubmit}>
                    <input
            ...
            <FoodListContainer>
                ...
                {mealPlan.foods !== undefined && mealPlan.foods.length !== 0
